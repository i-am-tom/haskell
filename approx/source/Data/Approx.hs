...
deriving via Generically (x, y, z)
  instance (Approx x, Approx y, Approx z)
    => Approx (x, y, z)

deriving via Generically (x, y, z, w)
  instance (Approx x, Approx y, Approx z, Approx w)
    => Approx (x, y, z, w)
