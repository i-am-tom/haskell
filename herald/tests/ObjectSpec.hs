...
spec_object_basic_bad = test Rejection
  { _input     = Number 123
...
spec_object_basic_good = test Acceptance
  { _input  = Object []
  , _schema = object $ pure ()
  }

spec_object_required_bad :: Spec
spec_object_required_bad = test Rejection
  { _input     = Object []
...
spec_object_required_good = test Acceptance
  { _input  = Object []
  , _schema = object $ pure ()
  }

spec_object_optional_missing :: Spec
spec_object_optional_missing = test Acceptance
  { _input  = Object []
  , _schema = object $ void $ optional "hello" $ pure ()
  }

spec_object_optional_present_bad :: Spec
spec_object_optional_present_bad = test Rejection
  { _input     = Object [("hello", Number 123)]
...
spec_object_optional_present_good = test Acceptance
  { _input  = Object [("hello", Number 123)]
  , _schema = object $ void $ optional "hello" $ pure ()
  }

spec_object_additional_properties_bad :: Spec
spec_object_additional_properties_bad = test Rejection
...
spec_object_additional_properties_good = test Acceptance
  { _input  = Object [("whatever", "hello")]
  , _schema = object $ void $ additionalProperties $ string $ pure ()
  }

spec_object_additional_properties_with_other :: Spec
spec_object_additional_properties_with_other = test Acceptance
  { _input  = Object [("hello", Number 123)]
  , _schema = object do
