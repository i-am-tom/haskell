...
spec_number_exclusive_maximum_bad =
  test
    Rejection
      { _input = Number 3.5,
...
spec_number_exclusive_maximum_good =
  test
    Acceptance
      { _input = Number 3,
        _schema = number $ exclusiveMaximum *> maximum_ 3.5
